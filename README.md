...
<head>
    ...
    <meta name="description" content="Ohmyfood répertorie les menus de vos restaurants gastronomiques favoris, finis les temps d'attente au restaurant, commandez dés maintenant et retrouvez votre menu dés votre  arrivée !">
...
<body>
    ...
    <main>
      <section class="localisation">
        ...
        <h2 class="localisation__text">Paris, Belleville</h2>
      </section>

      <!-- Section A Propos -->
      <section class="about">
        <h2 class="about__title">Réservez le menu qui vous convient</h2>
      ...
      <section class="function">
        <div class="container">
          ...
          <ol class="function__steps">
            <li class="function__step">
              <i class="function__icon fas fa-mobile-alt"></i>
              <span class="text">Choisissez un restaurant</span>
            </li>
            <li class="function__step">
              <i class="function__icon fas fa-list-ul"></i>
              <span class="text">Composez votre menu</span>
            </li>
            <li class="function__step">
              <i class="function__icon fas fa-store"></i>
      ...
      <section class="restaurants" id="restaurants">
        <div class="container">
          ...
          <div class="cards">
            <a class="card" href="./menu-pages/la-palette-du-gout.html">
              <img src="./images/restaurants/menu1.jpg" alt="plat du menu du restaurant la palette du goût" class="card__img">
            ...
            <a class="card" href="./menu-pages/la-note-enchantee.html">
              <img src="./images/restaurants/menu2.jpg" alt="plat du menu du restaurant la note enchantée" class="card__img">
              <span class="card__badge">Nouveau</span>
              <div class="card__footer">
                <div class="card__content">
            ...
            <a class="card" href="./menu-pages/a-la-francaise.html">
              <img src="./images/restaurants/menu3.jpg" alt="plat du menu du restaurant à la francaise" class="card__img">
              <div class="card__footer">
                <div class="card__content">
            ...
            <a class="card" href="./menu-pages/le-delice-des-sens.html">
              <img src="./images/restaurants/menu4.jpg" alt="plat du menu du restaurant les délices des sens" class="card__img">
              <div class="card__footer">
                <div class="card__content">
